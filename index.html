    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col text-left">
                <!--<a href="#" id="viewHighScore">Ver resultados</a>-->
            </div>
            <div id="timer" class="col text-right">
                <i class="far fa-clock"></i> Tiempo restante: <span id="timeLeft">0</span>
            </div>
            <div id="timesUp" class="col text-right" style="display: none;">¡Tiempo terminado!</div>
        </div>

        <div id="everything" class="row text-center">
            <div class="col-md-2"></div>
              <main class="col-md-8 mt-5">
                  <!--start screen  -->
                  <div id="start" class="m-2 justify-content-center">
                      <h1 class="font-weight-bold pl-5 pr-5 mb-10" style="color:white">El respeto</h1>
                      <br>
                      ...
                      <button type="button" id="start-quiz-button" class="btn btn-info align-center mt-20">Empezar</button>
                  </div>

                  <!--quiz div  -->
                  <div id="questionDiv" style="display: none;">
                    <p id="questionTitle" class="pl-5 ml-2 pt-5 justify-content-center font-weight-bold"></p>
                    <div id="Input" class="text-center"></div>
                    <div class="pl-5 pt-2 pb-3 m-2 justify-content-center">
                        <button id="btn0" class="btn btn-dark"></button>
                        <button id="btn1" class="btn btn-dark"></button>
                  ...
                  <!-- score div -->
                    <div class="pl-5 ml-2 pt-5 justify-content-center font-weight-bold" id="summary" style="display: none;">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/UV9MT3k5Rwg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <form>
